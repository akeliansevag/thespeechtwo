                ...
                <div class="section-wrapper !pt-5">
                    ...
                    <div class="my-4 flex gap-2">
                        <?php foreach ($categories as $cat): ?>
                            <a class="hover:bg-gray-200 uppercase hover:!text-black text-xs bg-transparent rounded-full text-black border border-gray-200  py-1 px-2" href="<?= get_category_link($cat->term_id); ?>">
                                <?= $cat->name; ?>
                            </a>
                        <?php endforeach; ?>
                    </div>
