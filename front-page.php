...
<section class="section">
    <div class="container">
        <div class="flex items-center justify-center relative w-full overflow-hidden aspect-video">
            ...
            <div class="absolute max-lg:max-w-auto max-lg:w-full max-lg:text-center lg:max-w-[50%] flex flex-col gap-4 ltr:right-0 rtl:left-0 bottom-0 bg-white p-5">
...
<section class="section">
    <div class="container">
        <div class="who-we-are p-5 flex border-dashed border border-x-0 ">
            <h2 class="text-[#2A7374] text-lg border border-dashed border-y-0 border-l-0 pr-4 text-nowrap mt-[0.8px]">
            ...
            <div class="pl-4">
                <div class="flex items-center justify-between">
                    ...
                    <div class="hover:opacity-40 cursor-pointer" id="who-we-are-handle">
